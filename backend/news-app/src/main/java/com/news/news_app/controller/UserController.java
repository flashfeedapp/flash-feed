...
public class UserController {
    ...
    @GetMapping("/{deviceId}")
    public Users getUserDetails(@PathVariable String deviceId) throws Exception {
    ...
    public Users register(@RequestParam String deviceId) {
        return userService.registerUserIfNotExists(deviceId);
    }
}
